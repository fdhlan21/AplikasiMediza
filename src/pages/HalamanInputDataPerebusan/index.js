...
function HalamanInputDataPerebusan({navigation}) {
...
<View>
<TouchableOpacity  onPress={()=>navigation.navigate('HalamanScanPerebusan')}>
...
export default HalamanInputDataPerebusan;