...
function HalamanInputDataPencacahan({navigation}) {
...
<View>
<TouchableOpacity  onPress={()=>navigation.navigate('HalamanScanPencacahan')}>
...
export default HalamanInputDataPencacahan;