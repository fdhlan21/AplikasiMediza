...
<View style={{bottom:20}}>
    <Text  style={{color:colors.tertiary, fontFamily:'Alata-Regular', fontSize:25, textAlign:'center'}} >Pencacahan</Text>
</View>
...
<View style={{padding:10}}>
    <TouchableOpacity   onPress={()=>navigation.navigate('HalamanInputDataPencacahan')} style={{padding:10, backgroundColor:colors.tertiary, borderRadius:10, margin:20, justifyContent:'center'}}>
...
export default HalamanScanPencacahan;