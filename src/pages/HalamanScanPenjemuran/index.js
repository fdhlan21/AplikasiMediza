...
function HalamanScanPenjemuran({navigation}) {
  return (
...
<View style={{padding:10}}>
    <TouchableOpacity   onPress={()=>navigation.navigate('HalamanInputDataPenjemuran')} style={{padding:10, backgroundColor:colors.tertiary, borderRadius:10, margin:20, justifyContent:'center'}}>
...
export default HalamanScanPenjemuran;